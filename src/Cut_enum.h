...
enum class CUTS {
  ...
  eRJet1,       eRJet2,       eRCenJet,     eR1stJet,     eR2ndJet,   eRBJet,   eRWjet, eREENoiseVeto,
...
static std::unordered_map<CUTS, std::string, EnumHash> enumNames {
  ...
  {CUTS::eRWjet, "eRWjet"}, {CUTS::eREENoiseVeto, "eREENoiseVeto"}, {CUTS::eDiElec, "eDiElec"}, {CUTS::eDiMuon, "eDiMuon"}, {CUTS::eDiTau, "eDiTau"},
  ...
  {CUTS::eSusyCom, "eSusyCom"}, {CUTS::eMET, "eMET"}, {CUTS::eGNuTau, "eGNuTau"}, {CUTS::eGHadTau, "eGHadTau"}, 
  {CUTS::eRTrig1, "eRTrig1"}, {CUTS::eRTrig2, "eRTrig2"}, {CUTS::eGMatchedHadTau, "eGMatchedHadTau"}
  };
